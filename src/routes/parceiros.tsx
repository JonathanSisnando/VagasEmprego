...
export const Route = createFileRoute("/parceiros")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Perfis parceiros que divulgam vagas em Manaus junto com o Vagas Manaus Hoje.",
      },
      ...
      <header className="border-b border-black/5 bg-white px-4 py-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-2 text-sm text-muted-foreground">
            Perfis do Instagram e WhatsApp que divulgam vagas em Manaus e que trocam publicações com
            o Vagas Manaus Hoje.
          </p>
        </div>
      </header>
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        {PARCEIROS.length === 0 ? (
          <div className="rounded-3xl border border-dashed border-black/10 bg-white p-8 text-center">
            ...
            <p className="mt-2 text-sm text-muted-foreground">
              Tem um perfil que divulga vagas em Manaus? Fale com a gente para trocar divulgação.
            </p>
            <a
              href={whatsappLink(
                "Olá! Tenho um perfil que divulga vagas em Manaus e quero trocar divulgação com o Vagas Manaus Hoje.",
              )}
              target="_blank"
                ...
                <div className="mt-3 flex flex-wrap gap-2">
                  {p.instagram ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 rounded-lg bg-slate-100 px-3 py-1.5 text-xs font-bold"
                    >
                  ...
                  {p.whatsapp ? (
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="inline-flex items-center gap-1.5 rounded-lg bg-whatsapp/10 px-3 py-1.5 text-xs font-bold text-whatsapp"
                    >
