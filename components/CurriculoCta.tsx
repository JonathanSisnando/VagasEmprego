...
export function CurriculoCta({ variant = "banner", vaga, fonte }: CurriculoCtaProps) {
  ...
  return (
    <div className="flex flex-col items-start gap-4 rounded-3xl border border-blue-100 bg-blue-50 p-6 sm:flex-row sm:items-center sm:justify-between">
      <div className="flex items-start gap-4">
        <span className="flex size-11 shrink-0 items-center justify-center rounded-2xl bg-blue-700 text-white">
      ...
      <div className="flex w-full shrink-0 flex-col items-center gap-2 sm:w-auto">
        <Link
          href={href}
          className="inline-flex w-full items-center justify-center rounded-xl bg-blue-700 px-5 py-3 text-sm font-black text-white shadow-sm transition hover:bg-blue-800 sm:w-auto"
        >
